...
const BloodOxygenScreen = ({ initialSelectedTab = 'Día' }) => {
  ...
  const getData = (tab) => {
    ...
    switch (tab) {
      case 'Mes':
        ...
        data.datasets[0].data = [96, 95, 97, 98];
        summaryData.average = (96 + 95 + 97 + 98) / 4;
        summaryData.highest = Math.max(96, 95, 97, 98);
        summaryData.lowest = Math.min(96, 95, 97, 98);
        break;
      case 'Semana':
        data.labels = ['Lun', 'Mar', 'Mié', 'Jue', 'Vie', 'Sáb', 'Dom'];
        data.datasets[0].data = [96, 95, 96, 97, 96, 95, 96];
        summaryData.average = (96 + 95 + 96 + 97 + 96 + 95 + 96) / 7;
        summaryData.highest = Math.max(96, 95, 96, 97, 96, 95, 96);
        summaryData.lowest = Math.min(96, 95, 96, 97, 96, 95, 96);
        break;
      case 'Día':
        data.labels = ['12PM', '3PM', '6PM', '9PM'];
        data.datasets[0].data = [96, 95, 94, 96, 97, 98, 96, 95];
  ...
  return (
    ...
    >
      <View style={[styles.bloodOxygenContainer, { backgroundColor: isDarkMode ? '#1e1e1e' : '#ffffff' }]}>
      ...
      <Text style={[styles.menuText, { color: isDarkMode ? '#ffffff' : '#000000' }]}>Análisis del oxigeno en sangre</Text>
