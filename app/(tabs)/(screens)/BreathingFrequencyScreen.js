...
export default function RespiratoryRateScreen() {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <TouchableOpacity style={styles.menuItem} onPress={() => router.navigate('RespiratoryRateAnalysis')}>
        <Icon name="analytics-outline" size={25} color="#000" />
        <Text style={styles.menuText}>Análisis de la Frecuencia Respiratoria</Text>
